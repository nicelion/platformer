...
# Fonts
FONT_SM = pygame.font.Font("assets/fonts/spook.ttf", 32)
FONT_MD = pygame.font.Font("assets/fonts/spook.ttf", 64)
FONT_LG = pygame.font.Font("assets/fonts/spook.ttf", 72)
...
block_images = {"TL": load_image("assets/png/Tiles/Tile (1).png"),
                "TM": load_image("assets/png/Tiles/Tile (2).png"),
                "TR": load_image("assets/png/Tiles/Tile (2).png"),
                "ER": load_image("assets/png/Tiles/Tile (3).png"),
                "EL": load_image("assets/png/Tiles/Tile (2).png"),
